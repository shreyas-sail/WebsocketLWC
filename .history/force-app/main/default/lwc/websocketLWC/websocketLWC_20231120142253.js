...
export default class WebsocketLWC extends LightningElement {
  ...
  processIndexFullPacket(dvu) {
    ...
    let xAxisValue = new Date().toLocaleTimeString("it-IT"); //dvu.getInt32(this.position + 34, true);
    ...
    this.currentPoints = parseFloat(this.marketDataCollection[0].y).toFixed(2);
