        ...
        options: {
            ...
            scales: {
                xAxes: [{
                    type: 'linear',
                    ticks: {
                        suggestedMin: this.staticData[0].x,
                        suggestedMax: this.staticData[this.staticData.length -1].x,
                        stepSize: 30,
                    }
                }],
                yAxes: [{
                    ...
                    ticks: {
                        autoSkip: true,
                        suggestedMin: this.staticData[0].y,
                        suggestedMax: this.staticData[this.staticData.length -1].y,
                        stepSize: 20,
