        ...
        options: {
            ...
            scales: {
                xAxes: [{
                    type: 'linear',
                    ticks: {
                        suggestedMin: this.chartData[0].x,
                        suggestedMax: this.chartData[this.chartData.length -1].x,
                        stepSize: 30,
                    }
                }],
                yAxes: [{
                    ...
                    ticks: {
                        autoSkip: true,
                        suggestedMin: this.chartData[0].y,
                        suggestedMax: this.chartData[this.chartData.length -1].y,
                        stepSize: 20,
